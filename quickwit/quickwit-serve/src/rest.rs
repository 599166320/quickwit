...
use crate::search_api::{merge_bloom_handler, search_get_handler, search_plan_get_handler, search_plan_post_handler, search_post_handler};
...
fn search_routes(
    ...
    search_get_handler(search_service.clone())
        ...
        .or(merge_bloom_handler(search_service.clone()))
        .recover(recover_fn)
        .boxed()
}
