...
mod visitor;
mod wildcard_query;
pub mod bloom_might_contain_query;
...
pub enum QueryAst {
    ...
    Regex(RegexQuery),
    BloomMightContain(BloomMightContainQuery),
    MatchAll,
    MatchNone,
    Boost {
...
impl QueryAst {
    pub fn parse_user_query(
        ...
        match self {
            ...
            | ast @ QueryAst::BloomMightContain(_)
            => Ok(ast),
...
impl BuildTantivyAst for QueryAst {
    fn build_tantivy_ast_impl(
        ...
        match self {
            ...
            QueryAst::BloomMightContain(bloom_filter) => bloom_filter.build_tantivy_ast_call(
                schema,
                tokenizer_manager,
                search_fields,
                with_validation,
